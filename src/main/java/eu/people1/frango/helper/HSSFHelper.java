package eu.people1.frango.helper;
...
public class HSSFHelper {
	...
	public <T> T getCellValue(Sheet sheet, String sheetName, Class<T> type, Integer row, Integer col, boolean zeroIfNull)
		...
		throw new FileParsingException(getErrorMessage(DATA_TYPE_NOT_SUPPORTED, type.getName()));
	}
	 ...
	 *             invalid.
	 */
	String getStringCell(Cell cell) throws FileParsingException {
	 ...
	 *             invalid.
	 */
	Date getDateCell(Cell cell, Object... errorMessageArgs) throws FileParsingException {
		try {
			if (!HSSFDateUtil.isCellDateFormatted(cell)) {
				throw new FileParsingException(getErrorMessage(INVALID_DATE_FORMAT, errorMessageArgs));
			}
	...
	Double getDoubleCell(Cell cell, boolean zeroIfNull, Object... errorMessageArgs) throws FileParsingException {
		if (cell == null) {
		...
		case HSSFCell.CELL_TYPE_BLANK:
			return zeroIfNull ? 0d : null;
		default:
			throw new FileParsingException(getErrorMessage(INVALID_NUMBER_FORMAT, errorMessageArgs));
		}
	}

	Long getLongCell(Cell cell, boolean zeroIfNull, Object... errorMessageArgs) throws FileParsingException {
	...
	Integer getIntegerCell(Cell cell, boolean zeroIfNull, Object... errorMessageArgs) throws FileParsingException {
		Double doubleValue = getNumberWithoutDecimals(cell, zeroIfNull, errorMessageArgs);
